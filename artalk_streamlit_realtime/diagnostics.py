...
def render_pipeline_diagnostics(pipeline: ARTalkPipeline) -> None:
    ...
    stage_rows = [
        ...
        duration_row("Pipeline warm-up", durations, "pipeline_warmup"),
        duration_row("Warm-up streamer", durations, "warmup_streamer_feed"),
        duration_row("Warm-up smoother", durations, "warmup_smoother_feed"),
        duration_row("Warm-up render", durations, "warmup_render_chunks"),
    ...
    output_rows = [
        ...
        {"name": "audio idle silence frames", "value": int(metric_value(counters, "audio_idle_silence_frames"))},
    ...
    known_stage_keys = {
        ...
        "smoother_feed",
        "pipeline_warmup",
        "warmup_streamer_feed",
        "warmup_smoother_feed",
        "warmup_render_chunks",
